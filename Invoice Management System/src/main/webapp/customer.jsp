	...
	<section>
		<div class="container" style="margin-top: 3%;">
			...
			<div class="row">
				...
				<div class="col-md-6">
					<h3 style="text-decoration: underline;">CREATE CUSTOMER</h3>
					...
					<a href="./customerform.jsp" target="_blank" class="kuch-bhi">
						Click</a>
			...
			<div class="row" style="margin-top: 5%;">
				<div class="col-md-6">
					<h3 style="text-decoration: underline;">MANAGE CUSTOMER</h3>

					<p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Nam
						sunt dolor dolores facere aliquid sint pariatur quis nesciunt,
						incidunt commodi, itaque molestiae inventore quia? Animi?</p>
					<!-- <button href = "# " type="button" class="kuch"> Click</button> -->
					<a href="showcustomerdata" target="_blank" class="kuch">
						Click</a>
				</div>
				<div class="col-md-6">
